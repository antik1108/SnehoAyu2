...
const pinLoginIpLimiter = rateLimit({
    ...
    message: {
        success: false,
        code: 'TOO_MANY_REQUESTS',
        message: 'Too many PIN login attempts from this IP address. Please try again in 15 minutes.',
    },
...
const pinLoginPhoneLimiter = rateLimit({
    ...
    message: {
        success: false,
        code: 'TOO_MANY_REQUESTS',
        message: 'Too many PIN login attempts for this phone number. Please try again in 15 minutes.',
    },
    keyGenerator: (req) => {
