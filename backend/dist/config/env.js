...
function parseBcryptRounds() {
    const rounds = parsePositiveInteger('BCRYPT_PASSWORD_ROUNDS');
    if (rounds < 12) {
        throw new Error('[Config] BCRYPT_PASSWORD_ROUNDS must be at least 12.');
    }
    return rounds;
}
...
export const env = {
    ...
    REFRESH_TOKEN_EXPIRES_IN_DAYS: parsePositiveInteger('REFRESH_TOKEN_EXPIRES_IN_DAYS'),
